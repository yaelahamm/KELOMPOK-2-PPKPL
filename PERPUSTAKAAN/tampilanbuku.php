...
<table>
	...
	<table>
		...
		<?php  
			...
			if (isset($_POST['pencarian'])) {
				...
				$query = mysqli_query($mysqli, "select * from buku where judul_buku like '%$cari%' or id_buku like '%$cari%'");
            ...
            echo "<td>".$hasil['tahun_buku']."</td>";    
						echo "<td><a href='tambahbuku.php'>Tambah</a> | <a href='ubahbuku.php?id=$hasil[id_buku]'>ubah</a> | <a href='hapusbuku.php?id=$hasil[id_buku]'>Hapus</a></td></tr>"; 
    ...
    <?php  
      ...
      echo "<td>".$user_data['tahun_buku']."</td>";    
			echo "<td><a href='tambahbuku.php'>Tambah</a> | <a href='ubahbuku.php?id=$user_data[id_buku]'>Ubah</a> | <a href='hapusbuku.php?id=$user_data[id_buku]'>Hapus</a></td></tr>";        
		}
