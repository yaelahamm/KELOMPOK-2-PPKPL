    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="tambahpustakawan.php">Tambah</a>
          <a class="dropdown-item" href="ubahpustakawan.php">Ubah</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="tambahanggota.php">Tambah</a>
          <a class="dropdown-item" href="ubahanggota.php">Ubah</a>
        </div>
      </li>
      <li class="nav-item dropdown">
        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item" href="tambahbuku.php">Tambah</a>
          <a class="dropdown-item" href="ubahbuku.php">Ubah</a>
        </div>
      </li>
    </ul>
  </div>
...
<body>
    <a href="tampilananggota.php">Home</a>
    <br/><br/>
